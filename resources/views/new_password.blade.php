                        ...
                        <div class="main-content inloginp">
                            <form action="{{ route('password.update') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="my-form-control" name="confirm_password" placeholder="Confirm Your Password">
                                    <p class="error-msg">{{ $errors->first("confirm_password")}}</p>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="default-btn"><span>{{ __('Reset Password') }}</span></button>
                                </div>
                                <div class="or">
                                    <p>OR</p>
                                </div>
