<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <a href="http://etogetherness.test" style="mso-line-height-rule: exactly;
 ...
 all on your desktop.">
                                  <p align="none" alt="Lingo is the best way to
 organize, share and use all your visual assets in one place - all on your desktop." height="32" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 107px; height: 32px; margin: 0px;" width="107">ETogetherness </p>
                                </a>
                              </td>
                            </tr>
                          </tbody>
